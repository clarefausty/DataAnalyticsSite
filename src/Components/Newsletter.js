        ...
        <div className='max-w-[1240px] mx-auto grid lg:grid-cols-3'>
            ...
            <div>
                <div className=' items-center flex flex-col sm:flex-row justify-between w-full my-4 '>
                    <input className='p-3 rounded-md w-full text-black '  type='email' placeholder='Enter email'/>
                    <button className='bg-[#00df9a] rounded-md w-[200px] font-medium px-6 py-3  mx-auto my-6 ml-4 text-black'>Notify me</button>
                </div>
